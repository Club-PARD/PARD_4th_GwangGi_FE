...
function QPage6() {
    ...
    const handleSubmit = () => {
        updateFormData('question6', selectedValue === 'option1' ? 0 : selectedValue === 'option2' ? 1 : selectedValue === 'option3' ? 2 : selectedValue === 'option4' ? 3 : selectedValue === 'option5' ? 4 : selectedValue === 'option6' ? 5 : selectedValue === 'option7' ? 6 : selectedValue === 'option8' ? 7 : selectedValue === 'option9' ? 8 : selectedValue === 'option10' ? 9 : selectedValue === 'option11' ? 10 : 11);
        navigate('/t_7');
    };
